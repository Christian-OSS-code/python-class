...
import overalllowestsubjectscore
import overallbeststudent
import overallworststudent
import generalclassaverage
...
class TestStudentGrade(TestCase):
    ...
    def test_that_student_grade_returns_correct_overall_lowest_score(self):
        actual = overalllowestsubjectscore.get_overalllowestsubjectscore({"student 1": [30, 20, 20], "student 2": [10, 90, 40], "student 3": [90, 50, 76]})
        expected = 10
        self.assertEqual(actual, expected)



    def test_that_student_grade_returns_correct_overallbestgraduating_student_score(self):
        actual = overallbeststudent.get_overallbeststudent({"student 1": [30, 20, 20], "student 2": [10, 90, 40], "student 3": [90, 50, 76]})
        expected = 216
        self.assertEqual(actual, expected)



    def test_that_student_grade_returns_correct_overallworstgraduating_student_score(self):
        actual = overallworststudent.get_overallworststudent({"student 1": [30, 20, 20], "student 2": [10, 90, 40], "student 3": [90, 50, 76]})
        expected = 70
        self.assertEqual(actual, expected)
    ...
    def test_that_student_grade_returns_correct_general_class_average(self):
        actual = generalclassaverage.get_generalclassaverage({"student 1": [30, 20, 20], "student 2": [10, 90, 40], "student 3": [90, 50, 76]})
        expected = 142.00
        self.assertEqual(actual, expected)
