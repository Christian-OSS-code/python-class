...
def get_overallhighestsubjectscore(student_records:dict):
    ...
    print(f"The overall highest score is scored by student {highest_student_list} in subject{overall_highest_student}")
...
def get_overalllowestsubjectscore(student_records:dict):
    ...
    print(f"The overall lowest score is scored by student in subject{overall_lowest_student}")
