...
import validityofcreditcardnumber
...
class TestCreditCardCheckerExistence(TestCase):
    ...
    def test_whether_credit_card_number_is_valid(self):
        actual = validityofcreditcardnumber.get_validityofcreditcardnumber(4388576018402626)
        expected = "Credit Card Number is Invalid"
        self.assertEqual(actual, expected)
