...
class TestSumOfNumbers1(TestCase):
    ...
    def test_that_squareroot_returns_correct_value(self):
        actual = squareroot.get_squareroot(25)
        expected = True
        self.assertEqual(actual, expected)

    def test_that_palindrome_exists(self):
        palindrome.get_palindrome(5321235)
    def test_that_palindrome_returns_correct_value(self):
        actual = palindrome.get_palindrome(5321235)
        expected = True 
    def test_that_factorial_exists(self):
        factorial.get_factorial(5)
    def test_that_factorial_returns_correct_value(self):
        actual = factorial.get_factorial(5)
        expected = 120
        self.assertEqual(actual, expected)
