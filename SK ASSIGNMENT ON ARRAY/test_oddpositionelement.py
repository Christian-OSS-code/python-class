...
class TestSumOfNumbers1(TestCase):
    ...
    def test_that_integerlist_returns_correct_value(self):
        actual = integerlist.get_integerlist(12345)
        expected = [1, 2, 3, 4, 5]
        self.assertEqual(actual, expected)

    def test_that_integerlist_returns_correct_value_for_inputs_in_tens(self):
        actual = integerlist.get_integerlist(100000)
        expected = [1, 0, 0, 0, 0, 0]
        self.assertEqual(actual, expected)
    def test_that_oddpositionelement_exists(self):
        oddpositionelement.get_oddpositionelement([1, 3, 4, 5, 7, 8, 10, 11])
    def test_that_oddpositionelement_returns_correct_value(self):
        actual = oddpositionelement.get_oddpositionelement([1, 3, 4, 5, 7, 8, 10, 11])
        expected = [3, 5, 8, 11]
        self.assertEqual(actual, expected)
